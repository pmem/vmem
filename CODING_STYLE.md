...
used in writing VMEM code, but rather focuses on some VMEM-specific conventions,
...
[style checker program](https://github.com/pmem/vmem/blob/master/utils/cstyle)
...
See [CONTRIBUTING.md](https://github.com/pmem/vmem/blob/master/CONTRIBUTING.md) for details.
- A copy of the [BSD-style License](https://github.com/pmem/vmem/blob/master/LICENSE)
...
- Please, see [this](https://github.com/pmem/vmem/blob/master/src/test/README)
and [that](https://github.com/pmem/vmem/blob/master/src/test/unittest/README)
